...
#                 refs['country'] = ct
#                 # tk.label(form,text="emergency contact").pack()
#                 # self.emergency_entry=tk.Entry(form)
#                 # self.emergency_entry.pack()
...
# ui/permit_form_ui.py
# ============================================================
# Permit entry form — updated for new schema.
# Changes from old version:
#   - Countries / Occupations / Purposes / Regions now loaded
#     from DB via ticket_creator helpers (not hardcoded lists)
#   - Visitor form now collects: first_name, mid_name, last_name,
#     dob, gender, country, occupation, passport, photo
#   - Section B now has: Purpose (Trekking/Tourism/Research),
#     Region (trekking_regions table), Entry Point, Exit Point
#   - save_to_database() builds data dict with new field names
#     matching save_tourist() in ticket_creator.py
# ============================================================
